...
3. Plan the fix. If it crosses a function boundary, `architect` first. Delegate implementation to a subagent (model per the pack's `~/.claude/skills/poteto-mode/references/models.md`, role bug-fix) with a specific scope; review the diff.
